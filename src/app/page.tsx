      ...
      <section className="px-6 py-24 bg-neutral-900/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-400">See what our users have to say about Zoo AI</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 hover:border-purple-500/30 transition-all">
              ...
              <p className="text-neutral-300 mb-6 leading-relaxed">
                "Zoo AI completely transformed how our team works. What used to take hours now happens automatically. It's like having an extra team member who never sleeps."
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-500 text-sm">Head of Operations, TechFlow</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 hover:border-purple-500/30 transition-all">
              ...
              <p className="text-neutral-300 mb-6 leading-relaxed">
                "The learning curve was practically non-existent. Within a day, our entire team was using Zoo AI for everything from scheduling to data analysis. Game changer."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  JC
                ...
                <div>
                  ...
                  <p className="text-neutral-500 text-sm">CTO, DataStream Analytics</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 hover:border-purple-500/30 transition-all">
              ...
              <p className="text-neutral-300 mb-6 leading-relaxed">
                "We've tried other AI tools, but Zoo AI is in a league of its own. The multi-operation capabilities save us at least 15 hours per week. ROI was immediate."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  EP
                ...
                <div>
                  <p className="text-white font-semibold">Emily Parker</p>
                  <p className="text-neutral-500 text-sm">Founder, CloudScale Solutions</p>
                </div>
              </div>
            </div>
          </div>
